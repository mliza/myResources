...
def argOptions():
    ...
    parser.add_argument("-cpp", action="store_true", help="Create a c++ file")

    parser.add_argument("-py", action="store_true", help="Create a python file")

    parser.add_argument("-sh", action="store_true", help="Create a bash file")

    parser.add_argument("-m", action="store_true", help="Create a matlab file")
