...
% Energy Eq. - Einstein's notation
\newcommand{\energyEins}
{ \frac{D E}{Dt} = -\frac{1}{\rho}\PartialFrac{\Parenthesis{\Sub{u}{i} p}}{\Sub{x}{i}} + \nu\PartialFrac{\Sub{u}{i}}{\Sub{x}{j}}   \PartialFrac{\Sub{u}{j}}{\Sub{x}{i}} + \nu\frac{\partial^2E} {\partial\Sub{x}{j}\partial\Sub{x}{j}} -\Phi }
