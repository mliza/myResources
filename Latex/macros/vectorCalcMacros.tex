...
{\iint\limits_{A}\Parenthesis{\nabla\times {#1} }\cdot\,\hat{n}\,da  = \oint\limits_{C}{#1}\cdot \hat{n}\,dl}

% Divergence Theorem 
\newcommand{\divergenceTheorem}[1] %\divergenceTheorem{F}
{ \iiint\limits_{\forall}\Parenthesis{\nabla\cdot {#1}}d\forall = \oiint\limits_{A}{#1}\cdot\hat{n}\,da } 
...
{\frac{d}{dt}\iint\limits_{\Sigma_{(t)} } \vec{F} \cdot d\vec{a} = \iint\limits_{\Sigma_{(t)}} \Parenthesis{ \PartialFrac{\vec{F}}{t} +  \Parenthesis{\vec{F}\cdot\nabla}\vec{V} + \Parenthesis{ \nabla\cdot\vec{F} }\vec{V} - \Parenthesis{\nabla\cdot\vec{V}}\vec{F}}\cdot d\vec{a}  - \oint\limits_{\partial\Sigma_{(t)}} \Parenthesis{\vec{V}\times\vec{F}}\cdot d\vec{s} } 
