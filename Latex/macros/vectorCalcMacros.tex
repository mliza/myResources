...
{\frac{d}{dt}\iint\limits_{\Sigma_{(t)} } \vec{F}_{(\vec{r},t)} \cdot d\vec{a} = \iint\limits_{\Sigma_{(t)}} \Parenthesis{ \PartialFrac{\vec{F}_{(\vec{r},t)}}{t} + \SqBracket{ \nabla\cdot\vec{F}_{(\vec{r},t)}}\vec{V}}\cdot d\vec{a}  - \oint\limits_{\partial\Sigma_{(t)}} \SqBracket{\vec{V}\times\vec{F}_{(\vec{r,t})}}\cdot d\vec{s} } 
