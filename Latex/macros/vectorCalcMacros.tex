...
{ \Sub{\oint}{C}{#1}\cdot d\vec{l} = \iint\Parenthesis{\nabla\times {#1} }\cdot\,d\vec{s} }

% Divergence Theorem 
\newcommand{\divergenceTheorem}[1] %\divergenceTheorem{F}
{ \Sub{\iiint}{\forall}\Parenthesis{\nabla\cdot {#1}}d\forall = \Sub{\oiint}{s}\Parenthesis{{#1}\cdot\hat{n}}d\vec{s} } 

% Greens Theorem 
%\newcommand{greensTheorem}[2] %\greensTheorem{M}{N}
%{ \oint \Parenthesis{ {#1}dx + {#2}dy } = \int\int\Parenthesis{ \PartialFrac{M}{x} + \PartialFrac{L}{y}}dxdy } 
